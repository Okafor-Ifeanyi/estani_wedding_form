...
export const FORM_SCHEMA: FormSection[] = [
  {
    ...
    fields: [
      ...
      { name: "deadline", label: "When do you need it live?", type: "date" },
      {
        ...
        type: "text",
        placeholder: "estherandifeanyi.com",
      },
    ],
  },
  {
    ...
    fields: [
      {
        ...
        type: "text",
        placeholder: "Esther Adaeze Nwosu",
      },
      {
        name: "bride_short",
      ...
      },
      {
        ...
        type: "text",
        placeholder: "Ifeanyi Chukwuemeka Obi",
      },
      {
        name: "groom_short",
    ...
    fields: [
      {
        ...
        options: [
          {
            value: "Traditional marriage / Igba Nkwu",
      ...
      },
      {
        ...
        type: "text",
        placeholder: "Enugwu-Ukwu, Njikoka, Anambra State",
      },
      {
        name: "reception",
      ...
      },
      {
        ...
        rows: 3,
        placeholder:
          "Turn at the junction by the market, parking behind the parish hall",
        full: true,
      },
    ],
  },
    ...
    fields: [
      {
        ...
        type: "text",
        placeholder: "Mr & Mrs Nwosu",
      },
      {
        name: "groom_parents",
        label: "Groom's parents",
        type: "text",
        placeholder: "Mr & Mrs Obi",
      },
      {
        name: "party_leads",
        label: "Chief bridesmaid / best man",
        type: "text",
        placeholder: "Amaka Eze & Uche Nnamdi",
      },
      {
        name: "day_contact",
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "text",
        placeholder: "Aunty Ngozi — 0800 000 0000",
      },
      {
        name: "attire_avoid",
