...
function chapterFields(n: number): FormField[] {
  const hint = CHAPTER_HINTS[n - 1] ?? {
    year: "",
    title: "A moment worth keeping",
  };
  return [
    {
      groupLabel: `Chapter ${n}`,
      name: `ch${n}_year`,
      label: `Chapter ${n} — year`,
      type: "text",
      placeholder: hint.year || "Year",
      row: `ch${n}`,
    },
    {
      name: `ch${n}_title`,
...
//       { name: 'rsvp_target', label: 'Contact of the day?', type: 'text', placeholder: 'Email, WhatsApp number, or a Google Sheet' },
...
export const FORM_SCHEMA: FormSection[] = [
  {
    ...
    fields: [
      ...
      { name: "deadline", label: "Expected Delivery Date?", type: "date" },
      {
        name: "domain",
        label: "Preferred web address",
        type: "text",
        placeholder: "rachelandmichael.com",
      },
    ],
  },
  {
    ...
    title: "The couple",
    intro:
      "Names as you want them printed. The short names are what appear large on the cover.",
    fields: [
      {
        name: "bride_full",
        label: "Bride — full name",
        type: "text",
        placeholder: "Rachel Grace Adams",
      },
      {
        name: "bride_short",
        label: "Bride — name on the cover",
        type: "text",
        placeholder: "Rachel",
      },
      {
        ...
        type: "text",
        placeholder: "Michael David Bello",
      },
      {
        name: "groom_short",
        label: "Groom — name on the cover",
        type: "text",
        placeholder: "Michael",
      },
      {
        name: "monogram",
        label: "Monogram / seal letters",
        type: "text",
        placeholder: "R & M",
      },
      {
        name: "hashtag",
        label: "Couple name or hashtag",
        type: "text",
        placeholder: "RachelAndMichael2032",
      },
      {
        name: "cover_line",
        label: "Line for the cover, under your names",
        type: "text",
        placeholder: "Invite you to celebrate their traditional marriage",
        full: true,
      },
    ],
  },
  {
    ...
    title: "Your story",
    intro:
      "Write it however it comes out — rough notes are fine, we will shape the prose. Four chapters to start; add more if your story needs them.",
    repeat: STORY_CHAPTERS,
    fields: [
      {
        name: "story_met",
        ...
        type: "textarea",
        rows: 4,
        placeholder: "Where, when, who spoke first, what you remember most",
        full: true,
      },
      {
        name: "story_proposal",
        ...
        type: "textarea",
        rows: 4,
        placeholder: "How he asked, where, who was there, how she answered",
        full: true,
      },
      ...rowsUpTo(STORY_CHAPTERS.max).flatMap(chapterFields),
      {
        name: "quote",
        label: "A verse, proverb or quote you want on the page",
        type: "text",
        placeholder:
    ...
    fields: [
      {
        ...
        full: true,
        options: [
          { value: "Traditional marriage", label: "Traditional marriage" },
          { value: "Church wedding", label: "Church wedding" },
          { value: "Court / civil", label: "Court or civil" },
          { value: "Reception", label: "Reception" },
          { value: "After-party", label: "After-party" },
      ...
      {
        name: "reception",
        label: "Reception venue & time",
        type: "text",
        placeholder: "Family compound, 6:00 PM",
      },
      {
        name: "maps_link",
      ...
      {
        name: "directions",
        label: "Parking, directions or landmarks worth noting",
        type: "textarea",
        rows: 3,
        placeholder:
          "Turn at the junction by the market, parking behind the venue hall",
        full: true,
      },
    ],
  },
  {
    ...
    title: "Order of the day",
    intro:
      "Six slots to start — add more if the day runs longer. Fill only the rows you need; we will trim the timeline to fit.",
    repeat: ORDER_ITEMS,
    fields: rowsUpTo(ORDER_ITEMS.max).flatMap(orderFields),
  },
  {
    ...
    fields: [
      {
        ...
        type: "text",
        placeholder: "Mr & Mrs Adams",
      },
      {
        name: "groom_parents",
        label: "Groom's parents",
        type: "text",
        placeholder: "Mr & Mrs Bello",
      },
      {
        name: "party_leads",
        label: "Chief bridesmaid / best man",
        type: "text",
        placeholder: "Grace Johnson & David Ekong",
      },
      {
        name: "day_contact",
        label: "Who guests should call on the day",
        type: "text",
        placeholder: "Name & number",
      },
      {
        name: "bridal_party",
        label: "Bridal party, if you want them listed",
        type: "textarea",
        rows: 3,
  ...
  },
  {
    ...
    title: "Dress code",
    intro:
      "Your guest colours appear on the site as spheres guests can match against. Tap a swatch to pick, or type the hex code if you already have it.",
    fields: [
      {
        name: "guest_color_1",
        label: "Guest colour 1",
        type: "color",
        default: "#5b1a2e",
      },
      {
        name: "guest_color_2",
        label: "Guest colour 2",
        type: "color",
        default: "#bbd3e2",
      },
      {
        name: "guest_color_3",
        label: "Guest colour 3",
        type: "color",
        default: "#b08d57",
      },
      {
        name: "guest_color_names",
        label: "Colour names, as guests say them",
        type: "text",
        placeholder: "Burgundy, powder blue, gold",
      },
      {
        name: "attire_note",
        label: "Attire guidance",
        type: "textarea",
        rows: 3,
        placeholder:
          "Traditional attire encouraged. Aso-ebi available from the family — contact us before 1 March.",
        full: true,
      },
      {
        name: "asoebi",
        label: "Aso-ebi contact or price",
        type: "text",
        placeholder: "Coordinator name — 0800 000 0000",
      },
      {
        name: "attire_avoid",
        label: "Anything guests should avoid wearing",
        type: "text",
        placeholder: "Please, no white",
      },
    ],
  },
  {
    ...
    fields: [
      ...
      {
        name: "rsvp_target",
        label: "Contact of the day?",
        type: "text",
        placeholder: "Email, WhatsApp number, or a Google Sheet",
      },
      {
        name: "guest_count",
      ...
      },
      {
        ...
        options: [
          "Yes, freely",
          "Only if named on the invitation",
          "No plus-ones",
        ],
      },
      {
      ...
      {
        name: "gift_bank",
        label: "Bank details for gifts",
        type: "text",
        placeholder: "Bank, account name, account number",
      },
      {
        name: "registry",
        label: "Registry or wishlist link",
        type: "url",
        placeholder: "https://...",
      },
      {
        name: "gift_note",
        label: "How you want to word the gift note",
        type: "textarea",
        rows: 3,
        placeholder:
          "Your presence is the gift. For those who insist on more...",
        full: true,
      },
    ],
  },
  {
    ...
    title: "Pictures, video & music",
    intro:
      "Pick your files here so we know what is coming. Large sets are easier by WeTransfer or a shared Drive link.",
    fields: [
      {
        name: "photo_hero",
      ...
      {
        name: "photo_portrait",
        label: "Portrait of the two of you",
        type: "file",
        accept: "image/*",
      },
      {
        name: "photo_gallery",
        label: "Gallery — up to twelve",
        type: "file",
        accept: "image/*",
        multiple: true,
      },
      {
        name: "audio_file",
        label: "Music for the site",
        type: "file",
        accept: "audio/*",
      },
      {
        name: "photo_link",
        label: "Or a link to your photo folder",
        type: "url",
        placeholder: "Drive, Dropbox or WeTransfer link",
      },
      {
        name: "song_name",
        label: "Song title, if we should source it",
        type: "text",
      ...
      },
      {
        ...
        type: "select",
        options: [
          "Yes, softly, when the envelope opens",
          "Only when a guest presses play",
          "No music at all",
        ],
      },
      {
  ...
  },
  {
    ...
    title: "Website Theme",
    intro:
      "What's the theme of the day? Take one of ours, or choose Custom and set your own three colours — tap a swatch to pick, or paste the hex code straight in.",
    fields: [
      {
        name: "palette",
        label: "What's the theme of the day?",
        ...
        options: [
          ...
          {
            value: "Dusty blue & blush",
            swatches: ["#5E7A90", "#E7C9C2", "#EDE7DE"],
          },
          {
            value: "Deep plum & champagne",
            swatches: ["#3E1F3D", "#E4D3B4", "#F2EDE6"],
          },
          { value: "Custom — my own colours", swatches: [] },
        ],
      },
      ...
      },
      {
        ...
        label: "Your second colour",
        type: "color",
        default: "#bbd3e2",
      },
      {
        name: "custom_metal",
        label: "Your metallic accent",
        type: "color",
        default: "#b08d57",
      },
      {
        name: "custom_palette_note",
        label: "Anything else about your colours?",
        type: "text",
        placeholder: "Match the aso-ebi exactly, keep the gold subtle…",
        full: true,
      },
      {
        name: "title_font",
        ...
        type: "select",
        options: [
          "Flowing script — romantic, calligraphic",
          "Classic serif — restrained, editorial",
          "Italic serif — soft, understated",
          "Surprise us",
        ],
      },
      {
        ...
        options: [
          "Eucalyptus & greenery",
          "Lilac and soft florals",
          "Gold line flourishes",
          "None — keep it plain",
        ],
      },
      {
        ...
        type: "select",
        options: [
          "Yes — wax seal a guest taps to open",
          "Yes, but keep it very short",
          "No — open straight onto the site",
        ],
      },
      {
        name: "mood",
      ...
      {
        name: "inspiration",
        label: "Sites or invitations you love",
        type: "textarea",
        rows: 3,
        placeholder: "Paste links, or describe what caught your eye",
        full: true,
      },
    ],
  },
  {
    ...
    fields: [
      ...
      {
        name: "hotels",
        label: "Hotels or lodging to recommend",
        type: "text",
        placeholder: "Name, area, rough price",
      },
      {
        name: "stream",
      ...
      },
      {
        ...
        rows: 4,
        placeholder:
          "Family sensitivities, wording to avoid, a detail that matters to you",
        full: true,
      },
    ],
  },
...
export const FILE_FIELDS: string[] = [
  "photo_hero",
  "photo_portrait",
  "photo_gallery",
  "audio_file",
...
export const FIELD_LABELS: Record<string, string> = FORM_SCHEMA.reduce<
...
export function filledRepeatRows(
  section: FormSection,
  values: FormValues,
): number {
  let highest = 0;
...
export const TOTAL_FIELDS: number = FORM_SCHEMA.reduce(
  (n, s) =>
    n +
    s.fields.filter((f) =>
      isCountedField(s, f, s.repeat ? s.repeat.initial : 0),
    ).length,
  0,
);
